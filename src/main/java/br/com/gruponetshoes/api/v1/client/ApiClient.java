...
import br.com.gruponetshoes.api.v1.client.auth.Authentication;
import br.com.gruponetshoes.api.v1.client.auth.HttpBasicAuth;
import br.com.gruponetshoes.api.v1.client.auth.ApiKeyAuth;
import br.com.gruponetshoes.api.v1.client.auth.OAuth;

public class ApiClient {
	private Map<String, Client> hostMap = new HashMap<String, Client>();
	private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
	private boolean debugging = false;
	private String basePath = "https://api-sandbox.netshoes.com.br/api/v1";
